...
class AddAdultInfo extends StatefulWidget {
  ...
  State<AddAdultInfo> createState() => _AddAdultInfoState(
...
class _AddAdultInfoState extends State<AddAdultInfo> {
  _AddAdultInfoState({
    required this.attractions,
    required this.attractionsAndCategory,
    required this.durationCount,
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
              ...
              onPressed: () {
                ...
                devtools.log('here : $yourTeamInfo');
